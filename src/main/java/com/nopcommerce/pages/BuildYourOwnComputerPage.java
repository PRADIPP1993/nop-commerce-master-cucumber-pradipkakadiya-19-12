...
public class BuildYourOwnComputerPage extends Utility {
    ...
    WebElement selectpocessor1;

    public void selectprocessor(){
        selectByVisibleTextFromDropDown(selectpocessor1,"2.5 GHz Intel Pentium Dual-Core E2200 [+$15.00]");
    ...
    public void clickram(){
       selectByVisibleTextFromDropDown(clickram,"8GB [+$60.00]");
    ...
    WebElement clickHDD1;
    public void clickHDD(){
        clickOnElement(clickHDD1);
    }
    ...
    WebElement clickso1;
    public void clickso() {
        clickOnElement(clickso1);
    }


    @CacheLookup
    @FindBy(xpath = "//input[@id='product_attribute_5_12']")
    WebElement clicksof1;
    public void clicksof() {
        clickOnElement(clicksof1);
    }
